...
.segment-white-header-text-without-date-container {
  max-width: 320px;
  margin-left: 40px;
  margin-top: 391px;
  position: absolute;
...
.segment-white-header-text-with-date-container {
  max-width: 320px;
  margin-left: 40px;
  margin-top: 361px;
  position: absolute;
